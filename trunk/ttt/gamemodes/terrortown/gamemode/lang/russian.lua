...
L.round_maniacs_one  = "Вы - последний маньяк."
L.round_maniacs_more = "Вы - маньяк. Ваши товарищи: {names}"
...
L.credit_man_all   = "Маньяки, вы награждены {num} кредитами за ваши действия."
...
L.equip_carry      = "Вы МОЖЕТЕ тащить это."
L.equip_carry_own  = "Вы уже тащите это."
L.equip_carry_slot = "У вас уже забит слот {slot}."
...
L.xfer_no_credits = "У вас нету кредитов чтобы переводить!"
L.xfer_send       = "Послать кредит"
...
L.xfer_success    = "Переведен кредит игроку {player}."
...
L.search_dmg_fall   = "Он упал и разбился."
L.search_dmg_boom   = "Его раны и подпаленая одежда указывают на то, что он взорвался."
L.search_dmg_club   = "Его одежда порвана. Видимо его забили."
L.search_dmg_drown  = "На теле много воды, видимо он утонул."
L.search_dmg_stab   = "Он получил ножевое ранение и был зарезан до того, как истек кровью."
...
L.search_dmg_other  = "Вы не можете определить причину смерти."
...
L.sb_confirmed  = "Подтвержденная смерть"
...
L.set_lang          = "Выбрать язык (Select language):"
...
L.buy_pending     = "Вы уже заказали это, подождите."
L.buy_received    = "Вы получили спец. экипировку."

L.drop_no_room    = "У Вас нет места. Выкиньте какое-нибуть оружие!"
...
L.c4_disarmed     = "Вы успешно деактивировали бомбу."
...
L.c4_disarm_t     = "Вы - Предатель. Перережьте любой провод для деактивации бомбы. Для Невиновных это не так легко!"
...
L.vis_help_pri    = "{primaryfire} активирует устройство."
...
L.decoy_help_pri  = "{primaryfire} активирует Приманку."
...
Горящий труп издаеи oderb.]]

-- Health station
L.hstation_name   = "Лечебная cтанция"
...
L.dna_no_killer   = "ДНК не может быть получена (убийца отсоединился?)."
...
-- Magneto stick
L.magnet_name     = "Палка-магнит"
L.magnet_help     = "{primaryfire} для прикрепления тела к поверхности."
...
-- Teleporter
L.tele_name       = "Телепортатор"
L.tele_failed     = "Телепортация не удалась."
...
L.tele_no_mark    = "Локация не отмечена! Отметьте локацию перед телепортацией."
...
L.spec_mode_warning = "Вы в режиме Наблюдения и не будете возрождаться. Чтобы отключить этот режим - зайдите в настройки и снимите галочку с \"Только наблюдение\"."
...
L.ev_goomba      = "{victim} был раздевлен весом {attacker}"
...
L.ev_c4_disarm1  = "{player} разминировал C4 игрока {owner}"
L.ev_c4_disarm2  = "{player} не смог разминировать C4 игрока {owner}"
L.ev_credit      = "{finder} нашел {num} кредит(а, ов) на теле {player}"

L.ev_start       = "Раунд начался"
L.ev_win_traitor = "Подлые Предатели выйграли раунд!"
L.ev_win_inno    = "Няшные Невиновные выйграли раунд!"
L.ev_win_time    = "У Предателей закончилось время, они проиграли!"
...
L.aw_nki2_title = "Присоединился к отряду правосудия"
...
L.aw_cbr1_text  = "очень любит махать ломиком, уже {num} человек в этом убедились."
...
L.aw_tkl4_text  = "убил всю свою команду. Его уже забанили, верно?"
...
--- v23
L.set_avoid_det     = "Не становитсья Детективом"
